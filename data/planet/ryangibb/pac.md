...
title: Pac
description:
url: https://ryan.freumh.org/pac.html
...
derivation<a href="https://ryan.freumh.org/#fn1" class="footnote-ref" role="doc-noteref"><sup>1</sup></a>.</span></p>
...
interoperability, we could resolve dependencies across ecosystems? <a href="https://github.com/fn06/pac">Pac</a> is a cross-ecosystem
...
conflicts. We see a number of use-cases for this system;</span></p>
<ol type="1">
...
dependencies, and Cargo has <a href="https://doc.rust-lang.org/cargo/reference/build-scripts.html#-sys-packages"><code class="verbatim">*-sys</code> packages</a>. Pac can add fine-grained and
versioned system dependencies to language ecosystems. This enables us
to, for example, solve for the smallest and most up-to-date container
...
each.</span></p></li>
<li><p><span><strong>Portable lockfiles:</strong> By solving
for all Operating Systems and architectures we can create truly portable
lockfiles.</span></p></li>
...
<p><span>Once we have Pac resolving dependencies across
...
for deployment, but perhaps we could bridge the gap with Pac.</span></p>
...
in the Nix store.</span><a href="https://ryan.freumh.org/#fnref1" class="footnote-back" role="doc-backlink">↩︎</a></p></li>
</ol>
</section>
